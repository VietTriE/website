<script lang="ts">
    ...
    let displayedProjects: Project[] = data.projects
...
<section class="bg-slate-100 py-16 px-4">
    <div class="container mx-auto">
        <div class="flex items-center gap-3 mt-8 md:mt-16 mb-12 lg:mb-16 lg:gap-6">
            ...
            <div class="flex">
                <span class="text-2xl lg:text-3xl"><strong>DỰ ÁN TIÊU BIỂU</strong></span>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 lg:gap-8">
            {#each displayedProjects as project}
                ...
                >
                    ...
                    <div class="p-4">
                        <h3 class="text-lg font-semibold mb-4 group-hover:text-blue-700 transition-colors">
                            {project.title}
                        </h3>
